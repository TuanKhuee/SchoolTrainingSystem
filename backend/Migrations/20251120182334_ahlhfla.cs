...
{
    /// <inheritdoc />
    public partial class ahlhfla : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedClasses = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    QrCodeExpiration = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_CoursePackages_CoursePackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeacherCodes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    PlaceBorn = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsParticipationConfirmed = table.Column<bool>(type: "bit", nullable: false),
                    ParticipationConfirmedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EvidenceImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivityRegistrations", x => new { x.StudentId, x.ActivityId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActivityRegistrations_AspNetUsers_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParentInfos_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rewards_Semesters_SemesterId",
                        column: x => x.SemesterId,
                        principalTable: "Semesters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TemporaryResidences", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TemporaryResidences_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TemporaryResidences_Semesters_SemesterId",
                        column: x => x.SemesterId,
                        principalTable: "Semesters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseRegistrations_CourseOfferings_CourseOfferingId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CourseRegistrationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Process = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_CourseRegistrationId",
                table: "Attendances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseRegistrations_CourseOfferingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_CoursePackageId",
                table: "Courses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParentInfos_StudentCode_Relationship",
                table: "ParentInfos",
                columns: new[] { "StudentCode", "Relationship" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ParentInfos_UserId",
                table: "ParentInfos",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Rewards_SemesterId",
                table: "Rewards",
                column: "SemesterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TemporaryResidences_SemesterId",
                table: "TemporaryResidences",
                column: "SemesterId");

            migrationBuilder.CreateIndex(
                name: "IX_TemporaryResidences_UserId",
                table: "TemporaryResidences",
                column: "UserId");
